...
### 🟠 D1 — Android native JS-liveness watchdog [APPROVED, native — bg-geo, RESEARCH-FIRST] — NEW
...
### 🟠 D2 — Android `GeofencingClient` wake-rail promoted: prototype NOW, not "only if 1–3 fail" [APPROVED, native — RESEARCH-FIRST]
